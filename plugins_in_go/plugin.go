...
import (
	...
	"sigs.k8s.io/kube-scheduler-simulator/simulator/docs/sample/weightedresidualresource"
)
...
var (
	...
	// TODO(user): add your plugins registries here.
	    	weightedresidualresource.Name: weightedresidualresource.NewWeightedResidualResourcePlugin,
		//nodenumber.Name: nodenumber.New,
	}


    	registeredOutOfTreeMultiPointName = []string{
           	weightedresidualresource.Name,
		//nodenumber.Name,
    	}
